...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  if (isset($_POST['Update']))
  {
    ...
    echo "The Value of sno in the update code is   ";
    echo $sno;
       ...
       $password=$_POST["password"];
        ...
        echo $name,$email,$coursecode,$password;



        $sql="UPDATE `StudentRecord` SET `Name`='$name' ,`Email`='$email', CourseCode='$coursecode', `Password`='$password' WHERE `sno`=$sno";
...
<!----------Here is the Credentials Input Container ----------------------->
    ...
    <div class="button">Update Student Details</div> -->
            ...
            <form action="/Student/views/index.php"  method="post">
            ...
            <div class="button">
            <button type="submit" action="submit" id="update_changes" class="btn btn-primary hidden  " name="Update" >Update</button>
            </div>
...
deletes=document.getElementsByClassName('delete');
  ...
  {
    console.log("yes");
    window.location=`/Student/views/index.php?delete=${sno}`;
  }
...
document.addEventListener("DOMContentLoaded", function() {
   ...
   const saveChangesButton = document.getElementById('update_changes');
   const addbutton=document.getElementById('Add_changes');
       ...
       element.addEventListener("click", (e) => {
         ...
         {
            sno=e.target.id.substring(1,);
          console.log("The Value of Sno in Edit is ");
         console.log(sno);
         }
...
saveChangesButton.addEventListener("click", () => {
    ...
    formData.append('sno', document.getElementById('edit_id').value); 
    ...
    .then(response => {
        if (response.ok) {
            ...
            // Refresh datatable (Assuming you have a function to refresh the datatable)
            refreshDatatable();
        } else {
